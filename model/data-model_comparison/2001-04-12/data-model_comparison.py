...
#***********************************************************************
Bz_raw = np.genfromtxt('./omni_min_4270.lst.txt', delimiter="", usecols = (4), dtype=float, autostrip=True)
...
Dp_raw = np.genfromtxt('./omni_min_4270.lst.txt', delimiter="", usecols = (5), dtype=float, autostrip=True)
